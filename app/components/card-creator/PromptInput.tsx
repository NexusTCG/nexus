...
export default function PromptInput({ onPromptChange }: PromptInputProps): React.ReactElement {
    ...
    return (
        <Box>
            ...
            <TextField
                ...
                multiline
                rows={2}
                placeholder={promptType === "content" ? "Write a content prompt.." : "Write an art prompt.."}
                inputRef={promptRef}
