...
export const abbreviationIcons = {
  ...
  "{V0}": { src: EnergyVoid0, name: "Void Energy 0"},
  "{V1}": { src: EnergyVoid1, name: "Void Energy 1"},
  "{V2}": { src: EnergyVoid2, name: "Void Energy 2"},
  "{V3}": { src: EnergyVoid3, name: "Void Energy 3"},
  "{V4}": { src: EnergyVoid4, name: "Void Energy 4"},
  "{V5}": { src: EnergyVoid5, name: "Void Energy 5"},
  "{V6}": { src: EnergyVoid6, name: "Void Energy 6"},
  "{V7}": { src: EnergyVoid7, name: "Void Energy 7"},
  "{V8}": { src: EnergyVoid8, name: "Void Energy 8"},
  "{V9}": { src: EnergyVoid9, name: "Void Energy 9"},
  "{V10}": { src: EnergyVoid10, name: "Void Energy 10"},
  "{V11}": { src: EnergyVoid11, name: "Void Energy 11"},
  "{V12}": { src: EnergyVoid12, name: "Void Energy 12"},
  "{V13}": { src: EnergyVoid13, name: "Void Energy 13"},
  "{V14}": { src: EnergyVoid14, name: "Void Energy 14"},
  "{V15}": { src: EnergyVoid15, name: "Void Energy 15"},
  "{VX}": { src: EnergyVoidX, name: "Void Energy X"},
  "{RM}": { src: RangeMelee, name: "Melee Range"},
  "{RR}": { src: RangeRanged, name: "Ranged Range"},
  "{S1}": { src: Speed1, name: "Speed 1"},
  "{S2}": { src: Speed2, name: "Speed 2"},
  "{S3}": { src: Speed3, name: "Speed 3"},
  "{L}": { src: StateLocked, name: "Locked State"},
  "{U}": { src: StateUnlocked, name: "Unlocked State"},
}