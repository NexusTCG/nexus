...
export const energyIcons = {
    yellow: {
        ...
        tailwindClass: "bg-yellow-300 text-black rounded-full",
        height: "20px",
        width: "20px",
        padding: "2px",
    },
    blue: {
        ...
        tailwindClass: "bg-sky-400 text-black rounded-full",
        height: "20px",
        width: "20px",
        padding: "2px",
    },
    purple: {
        ...
        value: "Purple energy",
        icon: DarkModeIcon,
        tailwindClass: "bg-purple-400 text-black rounded-full",
        height: "20px",
        width: "20px",
        padding: "2px",
    },
    red: {
        ...
        tailwindClass: "bg-red-400 text-black rounded-full",
        height: "20px",
        width: "20px",
        padding: "2px",
    },
    green: {
        ...
        value: "Green energy",
        icon: SpaIcon,
        tailwindClass: "bg-lime-400 text-black rounded-full",
        height: "20px",
        width: "20px",
        padding: "2px",
    },
    colorless: {
        ...
        tailwindClass: "bg-slate-400 text-black rounded-full",
        height: "20px",
        width: "20px",
        padding: "2px",
    },
